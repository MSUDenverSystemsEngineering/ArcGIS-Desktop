...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		<#
		$applicationList = 'ArcGIS Desktop'
		...
		#>
		$exitCode = Remove-MSIApplications -Name 'ArcGIS Desktop' -FilterApplication (,('Publisher', 'Environmental Systems Research Institute, Inc.', 'Exact'))
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		...
		$exitCode = Execute-Process -Path "$dirFiles\Setup.exe" -Parameters 'ESRI_LICENSE_HOST=27004@VMWAS22.WINAD.MSUDENVER.EDU ENABLEEUEI=0 ACCEPTEULA=yes SOFTWARE_CLASS=Professional SEAT_PREFERENCE=Float DESKTOP_CONFIG=TRUE /qn' -WindowStyle 'Hidden' -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Write-Log -Message "Attempting to run ArcGIS Desktop uninstaller..." -Source 'Installation' -LogType 'CMTrace'
		$exitCode = Execute-Process -Path "msiexec.exe" -Parameters "/x{791AB03F-1AF2-43FE-8F5D-8FDC9509D7CF} /quiet /norestart /log $Env:windir\Logs\Software\ArcGISDesktop10.8.2-uninstall.log" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUv2UOjXJsIvtRDhmAGAoIJKmk
# DkagghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFGOtQruG8F29DOpSG0ja/xei/oEbMA0GCSqGSIb3DQEBAQUABIIBgFKM9aq8
# 3C1ypYqy1F/+b0jeaCD/p4VCnlKrB3rz4dNQvJyCjplCVDijpzTd6xhUUujuszHO
# 0luxOAwHoYa04v17xd0Ivqpw3ldQF53vb/4fGc3MqxmpQSUTs9C29lmDxDohwr50
# hO2y6cITqlN7kRcQjsCPFDIdekjd7ovuBxvL4aJpYoJrHy7H1hd+9gFV/IwbA3sg
# wP1fiROJnUDNK6L7oSx/gwsudHkqdGv4YPJg7I2ybhl1tACVPcHz3J4BSoLEdfk3
# utZC8sZcI0IbIxVOC517Yrl62po/G1Jx9YjqWfPlr8yfZpIfn4/WI5M7pVnwpfxA
# Hp5UFRGfT+iIdfdH5rLJLveKf0nAWSj29c+Rsz7yjCmxjCbR+MtqM6kNAQUbe+5e
# zGo96LkqfitBuCMQR5pPlo6bMJOoaSe7kcreuOCu/94zdb6Fk646e8lc9vyGYHlf
# KuO0sIVdgMtmxSH5uPLSCH4Rcy0pSPobqVRxtqKwtmcLLzjM0Imm8942QQ==
