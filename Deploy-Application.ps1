...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Execute-Process -Path "$dirFiles\Setup.exe" -Parameters 'ESRI_LICENSE_HOST=27004@VMWAS22.WINAD.MSUDENVER.EDU GIS_SOFTWARE_CLASS=Professional SEAT_PREFERENCE=Float DESKTOP_CONFIG=TRUE /qn' -WindowStyle 'Hidden' -PassThru
